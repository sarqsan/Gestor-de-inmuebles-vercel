...
| 2026-09-21 | **GAP-R1** — Persistencia Firestore de la conciliación bancaria (GAP6) | `arena/01a0bfd3-gestor-de-inmuebles-vercel` @ `415de41` | `97ea0cb` | **INTEGRADO en canónica (Arena A, 2026-09-21, commit `a18967f`, cherry-pick selectivo, 0 conflictos)** | R1 15/15 · suite 850/850 · tsc 0 · build OK |
| 2026-09-21 | **GAP-R2** — Evidencias de morosidad en Storage (C) | `arena/01a0bfd3-gestor-de-inmuebles-vercel` @ `58a495a` | `415de41` | **INTEGRADO en canónica (Arena A, 2026-09-21, commit `92c8185`)** — `storage.rules` pendiente de publicar | R2 20/20 · suite 870/870 · tsc 0 · build OK |
| 2026-09-21 | **GAP-R3** — Seguridad de la ficha pública de inmueble | `arena/01a0bfd3-gestor-de-inmuebles-vercel` @ `8534b43` | `58a495a` | **INTEGRADO en canónica (Arena A, 2026-09-21, commit `5e47fc2`)** — reglas pendientes de publicar; sin backfill de fichas | R3 29/29 · suite 899/899 · tsc 0 · build OK |
