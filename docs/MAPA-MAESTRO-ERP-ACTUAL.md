...
- **Probado:** 23/23 (`conciliacion.test.ts`): parsers, matching, aplicación, idempotencia, trazabilidad. Persistencia: 27/27 (`conciliacion-persistencia.test.ts`, ver GAP-R1).
