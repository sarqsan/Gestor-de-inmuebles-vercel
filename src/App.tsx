...
export default function App() {
      ...
      if (usuarioApp) {
        ...
        setActiveSection((prev) => {
          if (usuarioApp.tipoPerfil === 'ADMINISTRADOR') {
            return prev === 'inicio' || prev === 'dashboard' ? 'dashboard' : prev;
          }
          if (usuarioApp.tipoPerfil === 'PROPIETARIO') {
            return prev === 'inicio' ? 'dashboard' : prev;
          }
  ...
  useEffect(() => {
    ...
    if (perfil === 'PROPIETARIO') {
      ...
      // ADMIN: permitir dashboard siempre
      const allowedAdmin: SectionType[] = [
        'dashboard',
        'inicio',
        'administracion',
        'inmuebles',
      ...
      if (!allowedAdmin.includes(activeSection)) {
        setActiveSection('dashboard');
      }
    }
