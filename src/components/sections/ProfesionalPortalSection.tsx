...
interface ProfesionalPortalSectionProps {
  ...
  /** Navegación a los módulos reales ya implementados (órdenes, presupuestos, valoraciones). */
        ...
        <div className="p-6">
          ...
          {activeTab === 'incidencias' && (
            <div className="space-y-6">
              {/* Accesos directos recuperados (navegación interna del rol profesional) */}
              {onNavigateToSection && (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <button
                    onClick={() => onNavigateToSection('incidencias')}
                    className="p-4 rounded-xl border border-slate-200 bg-white hover:border-blue-300 hover:bg-blue-50/40 transition-colors text-left space-y-2 cursor-pointer"
                  >
                    <div className="w-9 h-9 rounded-xl bg-blue-50 text-blue-700 flex items-center justify-center">
                      <AlertTriangle className="w-4 h-4" />
                    </div>
                    <div className="text-xs font-bold text-slate-900">Incidencias y Mantenimiento</div>
                    <div className="text-[11px] text-slate-500">
                      Partes de avería, dictamen IA y estado de cada reparación.
                    </div>
                    <div className="inline-flex items-center space-x-1 text-[11px] font-bold text-blue-700">
                  ...
                  <button
                    ...
                    className="p-4 rounded-xl border border-slate-200 bg-white hover:border-amber-300 hover:bg-amber-50/40 transition-colors text-left space-y-2 cursor-pointer"
                  >
                    <div className="w-9 h-9 rounded-xl bg-amber-50 text-amber-700 flex items-center justify-center">
                      <Briefcase className="w-4 h-4" />
                    </div>
                    <div className="text-xs font-bold text-slate-900">Mis Obras, Presupuestos y Valoraciones</div>
                    <div className="text-[11px] text-slate-500">
                      Órdenes asignadas, presupuestos emitidos y puntuación de tus trabajos.
                    </div>
                    <div className="inline-flex items-center space-x-1 text-[11px] font-bold text-amber-700">
                      <span>Abrir mis obras</span>
                      <ArrowRight className="w-3 h-3" />
                    </div>
                  </button>
                </div>
